...
class DlogHeroPluginManager extends DefaultPluginManager{
   ...
   *  The current route match.
   */
  public function __construct($type, Traversable $namespaces, CacheBackendInterface $cache_backend,
    ModuleHandlerInterface $module_handler, CurrentPathStack $path_current, PathMatcher $path_matcher,
